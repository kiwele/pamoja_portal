...
import { addAcademicInfo, addProject, adminViewMemberAcademicInfo, adminViewMemberPersonalInfo, adminViewMemberWorkInfo, deleteMember, getAcademicInfo, getAllMembers, getProjects, getworkInfo, manageMember, personalInfo, registerMember, test, updateAcademics, updateMember, workingExperience } from '../controllers/member.js';
...
router.put('/update_academic_info/:id', upload.none(), verifyaccessToken, updateAcademics);
router.post('/working_experience', upload.none(), verifyaccessToken, workingExperience);

router.post('/add_projects', upload.single('file'), verifyaccessToken, addProject);
